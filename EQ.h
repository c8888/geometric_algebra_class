...
public:
    ...
    void calcError3(double dtmin, double dtmax, double OverallTime, double logarithm_base, vsr::ega::Vec S0T, vsr::ega::Rot R0T); //calcError1 normalized to the same overall simulation time
    void calcError4(double dtmin, double dtmax, double OverallTime, double logarithm_base, vsr::ega::Vec S0T, vsr::ega::Rot R0T); //calcError2 normalized to the same overall simulation time
    void calcError5(double dtmin, double dtmax, double OverallTime, double logarithm_base, vsr::ega::Vec S0T, vsr::ega::Rot R0T); //calcError2 normalized to the same overall simulation time
